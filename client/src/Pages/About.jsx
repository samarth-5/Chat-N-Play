  ...
  return (
    <section className='my-20 mx-[200px] full-screen-bg'>
      ...
      <div className='flex justify-between'>
        <h1 className='text-3xl font-bold mb-4'>About <Link to='/'><span className='underline text-[#6531e0]'>Chat-N-Play</span></Link> (Developed by Samarth)</h1>
        <Link target="_blank" to='https://samarth-dev.netlify.app/'><FaGlobe size={30} className='text-[#6531e0] mr-5' /></Link>
      </div>
      ...
      <div className=' px-5 py-3 flex gap-3 outline outline-slate-600 hover:outline-[#6531e0] rounded-3xl w-min'>
        <Link target="_blank" to='https://www.linkedin.com/in/samarth-narayan-4a4998250/' className='hover:scale-150 duration-500'><FaLinkedin size={25} className='hover:text-[#6531e0]' /></Link> 
        <Link target="_blank" to='https://github.com/samarth-5' className='hover:scale-150 duration-500'><FaGithub size={25} className='hover:text-[#6531e0]' /></Link>
        <Link target="_blank" to='https://leetcode.com/u/samarth_123_/' className='hover:scale-150 duration-500'><SiLeetcode size={25} className='hover:text-[#6531e0]' /></Link>
        <Link target="_blank" to='https://www.instagram.com/samarth123_/' className='hover:scale-150 duration-500'><FaInstagram size={25} className='hover:text-[#6531e0]' /></Link>
      </div>
    </section>
  )
};